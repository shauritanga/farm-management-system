...
import '../../data/repositories/mock_farm_repository.dart';
import '../../domain/repositories/farm_repository.dart';
import '../states/farm_state.dart';
import '../../../subscription/domain/entities/subscription.dart';

/// Farm repository provider - using mock for development
final farmRepositoryProvider = Provider<FarmRepository>((ref) {
  // Use mock repository for development
  // TODO: Switch to FarmRepositoryImpl(FirebaseFirestore.instance) for production
